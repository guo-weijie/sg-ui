...
import { SgementUIComponent, SgementUIHorizontalAlignment } from "./component";
...
export declare class SgTableColumn extends SgementUIComponent {
  ...
  renderHeader: (h: CreateSgement, data: RenderHeaderData) => VNode | string;
  ...
  headerAlign: SgementUIHorizontalAlignment;
