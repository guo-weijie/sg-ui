      ...
      <ul class="container">
        <li>
          <div class="card">
            ...
            <router-link active-class="active" to="/zh-CN/guide/design" exact>查看详情 </router-link>
          </div>
        </li>
        <li>
          <div class="card">
        ...
        <li>
          <div class="card">
            ...
            <router-link active-class="active" to="/zh-CN/theme" exact>查看详情 </router-link>
          </div>
        </li>
        <li>
          <div class="card">
            ...
            <router-link active-class="active" to="/zh-CN/resource" exact>查看详情 </router-link>
          </div>
        </li>
      </ul>
    </div>
