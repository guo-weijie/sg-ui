...
export default {
  ...
  methods: {
    goCodepen() {
      ...
      const resourcesTpl = '<scr' + 'ipt src="//unpkg.com/vue@2/dist/vue.js"></scr' + 'ipt>' +
        '\n<scr' + `ipt src="//unpkg.com/sg-ui@${version}/lib/index.js"></scr` + 'ipt>';
      let jsTpl = (script || '').replace(/export default/, 'var Main =').trim();
      let htmlTpl = `${resourcesTpl}\n<div id="app">\n${html.trim()}\n</div>`;
      let cssTpl = `@import url("//unpkg.com/sg-ui@${version}/lib/theme-chalk/index.css");\n${(style || '').trim()}\n`;
      jsTpl = jsTpl
  ...
  computed: {
    ...
    iconClass() {
      return this.isExpanded ? 'sg-icon-caret-top' : 'sg-icon-caret-bottom';
    },
  ...
  watch: {
    isExpanded(val) {
      ...
      setTimeout(() => {
        this.scrollParent = document.querySelector('.page-component__scroll > .sg-scrollbar__wrap');
