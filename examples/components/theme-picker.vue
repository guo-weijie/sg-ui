<template>
  <sg-color-picker class="theme-picker" popper-class="theme-picker-dropdown" v-model="theme"></sg-color-picker>
</template>
...
.theme-picker .sg-color-picker__trigger {
  vertical-align: middle;
}

.theme-picker-dropdown .sg-color-dropdown__link-btn {
  display: none;
}
</style>
...
export default {
  ...
  watch: {
    theme(val, oldVal) {
      ...
      if (!this.chalk) {
        const url = `https://unpkg.com/sg-ui@${version}/lib/theme-chalk/index.css`;
