...
<sg-steps :active="active" finish-status="success">
  <sg-step title="Étape 1"></sg-step>
  <sg-step title="Étape 2"></sg-step>
  <sg-step title="Étape 3"></sg-step>
</sg-steps>

<sg-button style="margin-top: 12px;" @click="next">Prochaine étape</sg-button>
...
<sg-steps :space="200" :active="1" finish-status="success">
  <sg-step title="Terminé"></sg-step>
  <sg-step title="En cours"></sg-step>
  <sg-step title="Étape 3"></sg-step>
</sg-steps>
```
:::
...
```html
<sg-steps :active="1">
  <sg-step title="Étape 1" description="Une description"></sg-step>
  <sg-step title="Étape 2" description="Une description"></sg-step>
  <sg-step title="Étape 3" description="Une description"></sg-step>
</sg-steps>
```
:::
...
<sg-steps :active="2" align-center>
  ...
  <sg-step title="Étape 2" description="Une description"></sg-step>
  <sg-step title="Étape 3" description="Une description"></sg-step>
  <sg-step title="Étape 4" description="Une description"></sg-step>
</sg-steps>
```
:::
...
```html
<sg-steps :active="1">
  <sg-step title="Étape 1" icon="sg-icon-edit"></sg-step>
  <sg-step title="Étape 2" icon="sg-icon-upload"></sg-step>
  <sg-step title="Étape 3" icon="sg-icon-picture"></sg-step>
</sg-steps>
```
:::
...
:::demo Mettez simplement l'attribut `direction` à ` vertical` dans l'élément `sg-steps`.
...
<sg-steps :space="200" :active="1" simple>
  <sg-step title="Étape 1" icon="sg-icon-edit"></sg-step>
  <sg-step title="Étape 2" icon="sg-icon-upload"></sg-step>
  <sg-step title="Étape 3" icon="sg-icon-picture"></sg-step>
</sg-steps>
