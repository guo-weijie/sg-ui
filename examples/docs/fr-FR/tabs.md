...
```html
<template>
  <sg-tabs v-model="activeName" @tab-click="handleClick">
    <sg-tab-pane label="User" name="first">Utilisateur</sg-tab-pane>
    <sg-tab-pane label="Config" name="second">Config</sg-tab-pane>
    <sg-tab-pane label="Role" name="third">Rôle</sg-tab-pane>
    <sg-tab-pane label="Task" name="fourth">Tâche</sg-tab-pane>
  </sg-tabs>
</template>
<script>
  export default {
...
```html
<template>
  <sg-tabs type="card" @tab-click="handleClick">
    <sg-tab-pane label="User">Utilisateur</sg-tab-pane>
    <sg-tab-pane label="Config">Config</sg-tab-pane>
    <sg-tab-pane label="Role">Rôle</sg-tab-pane>
    <sg-tab-pane label="Task">Tâche</sg-tab-pane>
  </sg-tabs>
</template>
<script>
  export default {
...
```html
<template>
  <sg-radio-group v-model="tabPosition" style="margin-bottom: 30px;">
    <sg-radio-button label="top">En haut</sg-radio-button>
    <sg-radio-button label="right">À droite</sg-radio-button>
    <sg-radio-button label="bottom">En bas</sg-radio-button>
    <sg-radio-button label="left">À gauche</sg-radio-button>
  </sg-radio-group>

  <sg-tabs :tab-position="tabPosition" style="height: 200px;">
    <sg-tab-pane label="User">Utilisateur</sg-tab-pane>
    <sg-tab-pane label="Config">Config</sg-tab-pane>
    <sg-tab-pane label="Role">Rôle</sg-tab-pane>
    <sg-tab-pane label="Task">Tâche</sg-tab-pane>
...
<sg-tabs type="border-card">
  <sg-tab-pane>
    <span slot="label"><i class="sg-icon-date"></i> Route</span>
    Route
  </sg-tab-pane>
  <sg-tab-pane label="Config">Config</sg-tab-pane>
  <sg-tab-pane label="Role">Rôle</sg-tab-pane>
...
:::demo
```html
<sg-tabs v-model="editableTabsValue" type="card" editable @edit="handleTabsEdit">
  <sg-tab-pane
...
<sg-tabs v-model="editableTabsValue" type="card" closable @tab-remove="removeTab">
  <sg-tab-pane
    v-for="(item, index) in editableTabs"
    :key="item.name"
    :label="item.title"
