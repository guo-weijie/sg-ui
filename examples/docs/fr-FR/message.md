...
```html
<template>
  <sg-button :plain="true" @click="open">Afficher le message</sg-button>
  <sg-button :plain="true" @click="openVn">VNode</sg-button>
</template>
...
```html
<template>
  <sg-button :plain="true" @click="open2">success</sg-button>
  <sg-button :plain="true" @click="open3">warning</sg-button>
  <sg-button :plain="true" @click="open1">message</sg-button>
  <sg-button :plain="true" @click="open4">error</sg-button>
</template>
...
```html
<template>
  <sg-button :plain="true" @click="openCenter">Texte centré</sg-button>
</template>
...
```html
<template>
  <sg-button :plain="true" @click="openHTML">Utiliser du HTML</sg-button>
</template>
