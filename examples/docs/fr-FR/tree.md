...
:::demo
```html
<sg-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></sg-tree>
...
<div class="buttons">
  <sg-button @click="getCheckedNodes">Récupération par noeud</sg-button>
  <sg-button @click="getCheckedKeys">Récupération par clé</sg-button>
  <sg-button @click="setCheckedNodes">Sélection par noeud</sg-button>
  <sg-button @click="setCheckedKeys">Sélection par clé</sg-button>
  <sg-button @click="resetChecked">Reset</sg-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <sg-button size="mini" type="text" on-click={ () => this.append(data) }>Ajouter</sg-button>
              <sg-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Supprimer</sg-button>
            </span>
          </span>);
      }
    }
