...
```html
<sg-input placeholder="Entrez quelque chose" v-model="input"></sg-input>
...
```html
<sg-input placeholder="Entrez votre mot de passe" v-model="input" show-password></sg-input>
...
```html
<div>
  <sg-input placeholder="Entrez quelque chose" v-model="input1">
    <template slot="prepend">Http://</template>
  </sg-input>
</div>
<div style="margin-top: 15px;">
  <sg-input placeholder="Entrez quelque chose" v-model="input2">
    <template slot="append">.com</template>
  </sg-input>
</div>
<div style="margin-top: 15px;">
  <sg-input placeholder="Entrez quelque chose" v-model="input3" class="input-with-select">
    <sg-select v-model="select" slot="prepend" placeholder="Choisir">
      <sg-option label="Restaurant" value="1"></sg-option>
      <sg-option label="Num. Commande" value="2"></sg-option>
