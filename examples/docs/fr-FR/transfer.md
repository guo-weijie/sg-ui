...
<template>
  ...
  <div style="text-align: center">
    <sg-transfer
      ...
      @change="handleChange"
      :data="data">
      <sg-button class="transfer-footer" slot="left-footer" size="small">Opération</sg-button>
      <sg-button class="transfer-footer" slot="right-footer" size="small">Opération</sg-button>
    </sg-transfer>
