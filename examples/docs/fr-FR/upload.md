...
<sg-upload
  ...
  :file-list="fileList">
  <sg-button size="small" type="primary">Cliquer pour envoyer</sg-button>
  <div slot="tip" class="sg-upload__tip">Fichiers jpg/png avec une taille inférieure à 500kb</div>
</sg-upload>
<script>
  export default {
    data() {
...
<sg-upload
  ...
  <div class="sg-upload__text">Déposer les fichiers ici ou<em>cliquez pour envoyer</em></div>
  <div class="sg-upload__tip" slot="tip">Fichiers jpg/png avec une taille inférieure à 500kb</div>
</sg-upload>
```
:::
...
<sg-upload
  ...
  action="https://jsonplaceholder.typicode.com/posts/"
  :auto-upload="false">
  <sg-button slot="trigger" size="small" type="primary">Choisir un fichier</sg-button>
  <sg-button style="margin-left: 10px;" size="small" type="success" @click="submitUpload">Envoyer au serveur</sg-button>
  <div class="sg-upload__tip" slot="tip">Fichiers jpg/png avec une taille inférieure à 500kb</div>
</sg-upload>
<script>
  export default {
