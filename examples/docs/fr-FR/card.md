...
<sg-card class="box-card">
  <div slot="header" class="clearfix">
    <span>Card name</span>
    <sg-button style="float: right; padding: 3px 0" type="text">Bouton</sg-button>
  </div>
...
:::demo L'attribut `body-style` définit le style CSS du `body`. Cet exemple utilise aussi `sg-col` pour la mise en page.
```html
<sg-row>
