...
```html
<sg-button type="text" @click="dialogVisible = true">click to open the Dialog</sg-button>
...
<sg-dialog
  ...
  <span slot="footer" class="dialog-footer">
    <sg-button @click="dialogVisible = false">Cancel</sg-button>
    <sg-button type="primary" @click="dialogVisible = false">Confirm</sg-button>
  </span>
</sg-dialog>
...
```html
<!-- Table -->
<sg-button type="text" @click="dialogTableVisible = true">open a Table nested Dialog</sg-button>

<sg-dialog title="Shipping address" :visible.sync="dialogTableVisible">
...
<!-- Form -->
<sg-button type="text" @click="dialogFormVisible = true">open a Form nested Dialog</sg-button>

<sg-dialog title="Shipping address" :visible.sync="dialogFormVisible">
  <sg-form :model="form">
    <sg-form-item label="Promotion name" :label-width="formLabelWidth">
      <sg-input v-model="form.name" autocomplete="off"></sg-input>
    </sg-form-item>
    <sg-form-item label="Zones" :label-width="formLabelWidth">
      <sg-select v-model="form.region" placeholder="Please select a zone">
  ...
  <span slot="footer" class="dialog-footer">
    <sg-button @click="dialogFormVisible = false">Cancel</sg-button>
    <sg-button type="primary" @click="dialogFormVisible = false">Confirm</sg-button>
  </span>
</sg-dialog>
...
```html
<template>
  <sg-button type="text" @click="outerVisible = true">open the outer Dialog</sg-button>
  
  <sg-dialog title="Outer Dialog" :visible.sync="outerVisible">
    <sg-dialog
        width="30%"
        title="Inner Dialog"
    ...
    <div slot="footer" class="dialog-footer">
      <sg-button @click="outerVisible = false">Cancel</sg-button>
      <sg-button type="primary" @click="innerVisible = true">open the inner Dialog</sg-button>
    </div>
  </sg-dialog>
</template>
...
```html
<sg-button type="text" @click="centerDialogVisible = true">Click to open the Dialog</sg-button>
...
<sg-dialog
  ...
  <span slot="footer" class="dialog-footer">
    <sg-button @click="centerDialogVisible = false">Cancel</sg-button>
    <sg-button type="primary" @click="centerDialogVisible = false">Confirm</sg-button>
  </span>
</sg-dialog>
