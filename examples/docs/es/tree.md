...
<div class="buttons">
  <sg-button @click="getCheckedNodes">get by node</sg-button>
  <sg-button @click="getCheckedKeys">get by key</sg-button>
  <sg-button @click="setCheckedNodes">set by node</sg-button>
  <sg-button @click="setCheckedKeys">set by key</sg-button>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <sg-button size="mini" type="text" on-click={ () => this.append(data) }>Append</sg-button>
              <sg-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</sg-button>
            </span>
          </span>);
      }
    }
