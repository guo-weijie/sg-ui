...
```html
<template>
  <sg-button type="text" @click="open">Click to open the Message Box</sg-button>
</template>
...
```html
<template>
  <sg-button type="text" @click="open">Click to open Message Box</sg-button>
</template>
