...
```html
<template>
  <sg-button :plain="true" @click="open">Show message</sg-button>
...
```html
<template>
  <sg-button :plain="true" @click="openCenter">Centered text</sg-button>
</template>
...
```html
<template>
  <sg-button :plain="true" @click="openHTML">Use HTML String</sg-button>
</template>
