...
```html
<template>
  <sg-transfer v-model="value" :data="data"></sg-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <sg-transfer
      ...
      @change="handleChange"
      :data="data">
      <sg-button class="transfer-footer" slot="left-footer" size="small">操作</sg-button>
      <sg-button class="transfer-footer" slot="right-footer" size="small">操作</sg-button>
    </sg-transfer>
  </div>
