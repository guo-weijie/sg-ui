...
:::demo
```html
<sg-input v-model="input" placeholder="请输入内容"></sg-input>
...
```html
<sg-input placeholder="请输入密码" v-model="input" show-password></sg-input>
...
```html
<div>
  <sg-input placeholder="请输入内容" v-model="input1">
    <template slot="prepend">Http://</template>
  </sg-input>
</div>
<div style="margin-top: 15px;">
  <sg-input placeholder="请输入内容" v-model="input2">
    <template slot="append">.com</template>
  </sg-input>
</div>
<div style="margin-top: 15px;">
  <sg-input placeholder="请输入内容" v-model="input3" class="input-with-select">
    <sg-select v-model="select" slot="prepend" placeholder="请选择">
      <sg-option label="餐厅名" value="1"></sg-option>
      <sg-option label="订单号" value="2"></sg-option>
      <sg-option label="用户电话" value="3"></sg-option>
    </sg-select>
