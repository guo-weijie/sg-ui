...
```html
<sg-affix :offset="120">
  <sg-button type="primary">距离顶部 120px</sg-button>
</sg-affix>
```
:::
...
<div class="affix-container">
  <sg-affix target=".affix-container" :offset="80">
    <sg-button type="primary">指定容器</sg-button>
  </sg-affix>
</div>
```
:::
...
```html
<sg-affix position="bottom" :offset="20">
  <sg-button type="primary">距离底部 20px</sg-button>
</sg-affix>
```
:::
