...
<sg-menu :default-active="activeIndex" class="sg-menu-demo" mode="horizontal" @select="handleSelect">
  <sg-menu-item index="1">处理中心</sg-menu-item>
  <sg-submenu index="2">
    ...
    <sg-submenu index="2-4">
      ...
      <sg-menu-item index="2-4-1">选项1</sg-menu-item>
      <sg-menu-item index="2-4-2">选项2</sg-menu-item>
      <sg-menu-item index="2-4-3">选项3</sg-menu-item>
    </sg-submenu>
  </sg-submenu>
...
:::demo 通过`sg-menu-item-group`组件可以实现菜单进行分组，分组名可以通过`title`属性直接设定，也可以通过具名 slot 来设定。
```html
<sg-row class="tac">
  <sg-col :span="12">
    <h5>默认颜色</h5>
    <sg-menu
      ...
      <sg-submenu index="1">
        ...
        <sg-submenu index="1-4">
          <template slot="title">选项4</template>
          <sg-menu-item index="1-4-1">选项1</sg-menu-item>
        </sg-submenu>
      </sg-submenu>
...
<sg-radio-group v-model="isCollapse" style="margin-bottom: 20px;">
  <sg-radio-button :label="false">展开</sg-radio-button>
  <sg-radio-button :label="true">收起</sg-radio-button>
</sg-radio-group>
<sg-menu default-active="1-4-1" class="sg-menu-vertical-demo" @open="handleOpen" @close="handleClose" :collapse="isCollapse">
  <sg-submenu index="1">
    <template slot="title">
      <i class="sg-icon-location"></i>
