...
<div class="buttons">
  <sg-button @click="getCheckedNodes">通过 node 获取</sg-button>
  <sg-button @click="getCheckedKeys">通过 key 获取</sg-button>
  <sg-button @click="setCheckedNodes">通过 node 设置</sg-button>
  <sg-button @click="setCheckedKeys">通过 key 设置</sg-button>
  <sg-button @click="resetChecked">清空</sg-button>
</div>
