...
<sg-badge :value="12" class="item">
  <sg-button size="small">评论</sg-button>
</sg-badge>
<sg-badge :value="3" class="item">
  <sg-button size="small">回复</sg-button>
</sg-badge>
...
<sg-dropdown trigger="click">
  <span class="sg-dropdown-link">
    点我查看<i class="sg-icon-caret-bottom sg-icon--right"></i>
  </span>
...
```html
<sg-badge is-dot class="item">数据查询</sg-badge>
