<template>
  <table @click="handleYearTableClick" class="sg-year-table">
    <tbody>
      <tr>
...
import { isDate, range, nextDate, getDayCountOfYear } from 'sg-ui/src/utils/date-util';
import { arrayFindIndex, coerceTruthyValueToArray } from 'sg-ui/src/utils/util';
