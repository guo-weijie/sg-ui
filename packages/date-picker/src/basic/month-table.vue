<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="sg-month-table">
    <tbody>
...
import { isDate, range, getDayCountOfMonth, nextDate } from 'sg-ui/src/utils/date-util';
import { hasClass } from 'sg-ui/src/utils/dom';
import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'sg-ui/src/utils/util';
