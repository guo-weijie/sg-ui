<template>
  <transition name="sg-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div v-show="visible" class="sg-picker-panel sg-date-range-picker sg-popper" :class="[{
      ...
      <div class="sg-picker-panel__body-wrapper">
        ...
        <div class="sg-picker-panel__body">
          <div class="sg-date-range-picker__time-header" v-if="showTime">
            <span class="sg-date-range-picker__editors-wrap">
              <span class="sg-date-range-picker__time-picker-wrap">
                <sg-input size="small" :disabled="rangeState.selecting" ref="minInput"
                  :placeholder="t('el.datepicker.startDate')" class="sg-date-range-picker__editor"
                  :value="minVisibleDate" @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="sg-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <sg-input size="small" class="sg-date-range-picker__editor" :disabled="rangeState.selecting"
            ...
            <span class="sg-icon-arrow-right"></span>
            <span class="sg-date-range-picker__editors-wrap is-right">
              <span class="sg-date-range-picker__time-picker-wrap">
                <sg-input size="small" class="sg-date-range-picker__editor" :disabled="rangeState.selecting"
              ...
              <span class="sg-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <sg-input size="small" class="sg-date-range-picker__editor" :disabled="rangeState.selecting"
          ...
          <div class="sg-picker-panel__content sg-date-range-picker__content is-left">
            <div class="sg-date-range-picker__header">
              <button type="button" @click="leftPrevYear"
                class="sg-picker-panel__icon-btn sg-icon-d-arrow-left"></button>
              <button type="button" @click="leftPrevMonth"
                class="sg-picker-panel__icon-btn sg-icon-arrow-left"></button>
              <button type="button" @click="leftNextYear" v-if="unlinkPanels" :disabled="!enableYearArrow"
                :class="{ 'is-disabled': !enableYearArrow }"
                class="sg-picker-panel__icon-btn sg-icon-d-arrow-right"></button>
              <button type="button" @click="leftNextMonth" v-if="unlinkPanels" :disabled="!enableMonthArrow"
                :class="{ 'is-disabled': !enableMonthArrow }"
                class="sg-picker-panel__icon-btn sg-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
          ...
          <div class="sg-picker-panel__content sg-date-range-picker__content is-right">
            <div class="sg-date-range-picker__header">
      ...
      <div class="sg-picker-panel__footer" v-if="showTime">
        <sg-button size="mini" type="text" class="sg-picker-panel__link-btn" @click="handleClear">
          {{ t('el.datepicker.clear') }}
        </sg-button>
        <sg-button plain size="mini" class="sg-picker-panel__link-btn" :disabled="btnDisabled"
...
export default {
  ...
  components: { TimePicker, DateTable, SgInput, SgButton }
};
</script>
