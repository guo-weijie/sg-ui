  ...
  <transition name="sg-zoom-in-top" @after-leave="doDestroy">
    <div class="sg-color-dropdown" v-show="showPopper">
      ...
      <div class="sg-color-dropdown__btns">
        ...
        <sg-button size="mini" type="text" class="sg-color-dropdown__link-btn" @click="$emit('clear')">
          {{ t('el.colorpicker.clear') }}
        </sg-button>
        <sg-button plain size="mini" class="sg-color-dropdown__btn" @click="confirmValue">
