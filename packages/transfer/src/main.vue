<template>
  <div class="sg-transfer" :class="this.buttonDirection === 'vertical'?'verticalTransfer':''">
    ...
    <div class="sg-transfer__buttons" :class="this.buttonDirection === 'vertical'?'verticalTransferBtn':''">
      <sg-button type="primary" :class="['sg-transfer__button', hasButtonTexts ? 'is-with-texts' : '']"
...
export default {
  ...
  props: {
    ...
    buttonIcons:{
      type: Array,
      default() {
        return ['sg-icon-arrow-left','sg-icon-arrow-right'];
      }
    },
