import Vue from 'vue';
import { hasClass, addClass, removeClass } from 'sg-ui/src/utils/dom';
...
export default {
        ...
        <thead class={[{ 'is-group': isGroup, 'has-gutter': this.hasGutter }]}>
          {
            this._l(columnRows, (columns, rowIndex) =>
              ...
              >
                    ...
                    <div class={['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName]}>
                      ...
                      }
                      {
                        column.filterable ? (<span
                          class="sg-table__column-filter-trigger"
                          on-click={($event) => this.handleFilterClick($event, column)}>
                          <i class={['sg-icon-arrow-down', column.filterOpened ? 'sg-icon-arrow-up' : '']}></i>
                        </span>) : ''
                      }
                    </div>
                  </th>))
                ...
                {
                  this.hasGutter ? <th class="sg-table__cell gutter"></th> : ''
                }
              </tr>
            )
          }
  ...
  methods: {
    ...
    handleFilterClick(event, column) {
      ...
      cell = cell.querySelector('.sg-table__column-filter-trigger') || cell;
