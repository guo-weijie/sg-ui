<template>
  ...
  >
    ...
    >
      ...
      <div v-if="$slots.append" class="sg-table__append-wrapper" ref="appendWrapper">
...
import Mousewheel from 'sg-ui/src/directives/mousewheel';
...
export default {
  ...
  created() {
    this.tableId = 'sg-table_' + tableIdSeed++;
