          ...
          <tr class="sg-descriptions-row">
            {
              row.map(item => {
                return (
                  <th
                    class={{
                      'sg-descriptions-item__cell': true,
                      'sg-descriptions-item__label': true,
          ...
          <tr class="sg-descriptions-row">
            {
              row.map(item => {
                return (
                  <td
                    class={['sg-descriptions-item__cell', 'sg-descriptions-item__content', item.contentClassName]}
        ...
        <tr class="sg-descriptions-row">
          {
            row.map(item => {
              return (
                <td class="sg-descriptions-item sg-descriptions-item__cell" colSpan={item.props.span}>
                  <div class="sg-descriptions-item__container">
                    <span
                      class={{
                        'sg-descriptions-item__label': true,
                    ...
                    >{item.label}</span>
                    <span
                      class={['sg-descriptions-item__content', item.contentClassName]}
                      style={item.contentStyle}
