...
import SgRadio from 'sg-ui/packages/radio';
import { isEqual } from 'sg-ui/src/utils/util';
...
export default {
  ...
  methods: {
    ...
    renderCheckIcon(h) {
      return (
        <i class="sg-icon-check sg-cascader-node__prefix"></i>
      );
    },

    renderLoadingIcon(h) {
      return (
        <i class="sg-icon-loading sg-cascader-node__postfix"></i>
      );
    },

    renderExpandIcon(h) {
      return (
        <i class="sg-icon-arrow-right sg-cascader-node__postfix"></i>
      );
    },
    ...
    renderContent(h) {
      ...
      return (
        <span class="sg-cascader-node__label">{vnode || node.label}</span>
      );
    }
  },
